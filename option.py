...
parser.add_argument('--model_dir', default='models/lj_oct', help='directory of the model')
...
parser.add_argument('--save_model_epoch', type=int, default=300, help='训练几个epoch保存一次模型')
