...
# 地址
parser.add_argument(
    "--dir_data", type=str, default="train_real", help="dataset directory"
)
parser.add_argument(
    "--dir_test_ori_img",
    type=str,
    default="test_real",
    help="Original image address of test data",
)
parser.add_argument(
    "--dir_test_noi_img",
    type=str,
    default="test_noise",
    help="Noise image address of test data",
)
parser.add_argument(
    "--save_test_dir",
    type=str,
    default="save_test_image",
    help="save test image address",
)
# 分块
parser.add_argument("--patch_size", type=int, default=64, help="output patch size")
parser.add_argument(
    "--n_pat_per_image", type=int, default=256, help="a image produce n patches"
)
parser.add_argument(
    "--sigma",
    type=int,
...
parser.add_argument(
    "--test_batch_size", type=int, default=1, help="input batch size for training"
)
...
parser.add_argument(
    "--loss_func", type=str, default="l2", help="choose the loss function"
)
parser.add_argument(
    "--start_epoch", type=int, default=0, help="the state is saved to here"
)
parser.add_argument(
    "--save_model_epoch", type=int, default=300, help="训练几个epoch保存一次模型"
)
